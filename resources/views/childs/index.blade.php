...
<body class="flex overflow-auto box-border">
    ...
    <main class="grow-5 mx-5">
        <h2 class="font-extrabold text-5xl mb-2 mt-10">Manajemen Data Balita</h2>
        <div class="flex w-inherit justify-end mt-16 mx-5">
            <button class="flex shadow-sm py-2 px-3 rounded-lg bg-green-400 items-center"><img src="{{asset('images/icon/Add.png')}}" alt="icon4" class="w-8"><span class="ml-3 text-lg font-medium text-white">Tambah Data Balita</span></button>
        </div>
        <x-table>
            <thead class="bg-gray-500">
                <tr>
                    ...
                    <td class="border border-black px-5 py-1 text-lg text-white font-medium text-center">Jenis Kelamin</td>
                    <td class="border border-black px-5 py-1 text-lg text-white font-medium text-center">Nama Ibu</td>
                    <td class="border border-black px-5 py-1 text-lg text-white font-medium text-center">Action</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="border px-5 py-1 text-center">Martin Kang Main</td>
                    <td class="border px-5 py-1 text-center">08-01-2025</td>
                    <td class="border px-5 py-1 text-center">70 Cm</td>
                    <td class="border px-5 py-1 text-center">8 Kg</td>
                    <td class="border px-5 py-1 text-center">Laki-Laki</td>
