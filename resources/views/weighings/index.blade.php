...
<body class="flex overflow-auto box-border">
    ...
    <main class="grow-5 mx-5">
        <h2 class="font-extrabold text-5xl mb-2 mt-10">Data Riwayat Penimbangan Balita</h2>
        <div class="flex w-inherit justify-end mt-16 mx-5">
            <button class="flex shadow-sm py-2 px-3 rounded-lg bg-green-400 items-center"><img src="{{asset('images/icon/Add.png')}}" alt="icon4" class="w-8"><span class="ml-3 text-lg font-medium text-white">Tambah Data Penimbangan Balita</span></button>
        </div>
        <x-table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border px-5 py-1 text-center">25-01-2025</td>
