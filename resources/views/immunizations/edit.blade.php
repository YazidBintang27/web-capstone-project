...
<body class="flex overflow-auto box-border">
    ...
    <main class="grow-5 mx-7.5">
        <h2 class="font-extrabold text-5xl mb-2 mt-10">Tambah Data Imunisasi</h2>
        ...
        <form method="post" class="w-inherit mt-10">
            <fieldset class="w-inherit flex gap-10">
                ...
                <fieldset class="grow-1">
                    <label class="font-medium transition-colors duration-300 ease-in-out peer-disabled:opacity-70 text-xs whitespace-nowrap text-black" for="mothersNik">Masukan Tanggal Imunisasi</label>
                    <div class="relative w-full">
                        <input
                        class="w-full rounded-lg border border-slate-200 px-3 text-sm font-medium placeholder-slate-400 outline-none transition-all duration-300 ease-in-out disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400 disabled:placeholder-slate-400 focus:border-blue-600 py-2 mb-0.5"
                        aria-disabled="false" aria-describedby=":S2:" id="mothersNik" placeholder="Masukan TB..." type="date">
                    </div>
                </fieldset>
            </fieldset>
            <fieldset class="mt-5">
                <fieldset>
                    <label class="font-medium transition-colors duration-300 ease-in-out peer-disabled:opacity-70 text-xs whitespace-nowrap text-black" for="mothersNik">Jenis Vaskin</label>
                    <div class="relative w-full">
                        <input
                        class="w-full rounded-lg border border-slate-200 px-3 text-sm font-medium placeholder-slate-400 outline-none transition-all duration-300 ease-in-out disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400 disabled:placeholder-slate-400 focus:border-blue-600 py-2 mb-0.5"
                        aria-disabled="false" aria-describedby=":S2:" id="mothersNik" placeholder="Masukan Jenis Vaksin..." required>
                    </div>
                </fieldset>
            </fieldset>
