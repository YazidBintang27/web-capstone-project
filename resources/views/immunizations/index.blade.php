...
<body class="flex overflow-auto box-border">
    ...
    <main class="grow-5 mx-5">
        <h2 class="font-extrabold text-5xl mb-2 mt-10">Data Riwayat Imunisasi Balita</h2>
        <div class="flex w-inherit justify-end mt-16 mx-5">
            <button class="flex shadow-sm py-2 px-3 rounded-lg bg-green-400 items-center"><img src="{{asset('images/icon/Add.png')}}" alt="icon4" class="w-8"><span class="ml-3 text-lg font-medium text-white">Catat Data Imunisasi</span></button>
        </div>
        <x-table>
            <thead class="bg-gray-500">
                <tr>
                    <td class="border border-black px-5 py-1 text-lg text-white font-medium text-center">Nama Balita</td>
                    <td class="border border-black px-5 py-1 text-lg text-white font-medium text-center">Jenis Vaksin</td>
                    <td class="border border-black px-5 py-1 text-lg text-white font-medium text-center">Tanggal Imnuisasi</td>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border px-5 py-1 text-center"><span class="bg-green-400 text-white font-bold py-2 px-3 text-sm rounded-full">BCG</span></td>
